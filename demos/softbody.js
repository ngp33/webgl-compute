...
for (int i = 0; i < 8; i++) {
  ...
  vec4 AB = (${glComp.MACROS.fbo_idx("pos", `otherIdx / ${PARTICLES_H}`, `otherIdx % ${PARTICLES_H}`)} - posA);
  vec4 velAB = (${glComp.MACROS.fbo_idx("vel", `otherIdx / ${PARTICLES_H}`, `otherIdx % ${PARTICLES_H}`)} - velA);
